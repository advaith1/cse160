...
class Vector3 {
	/** @param {[number, number, number]} opt_src */
    constructor(opt_src) {
        var v = new Float32Array(3);
        if (opt_src && typeof opt_src === 'object') {
          if (opt_src.elements) opt_src = opt_src.elements;
          v[0] = opt_src[0];
          v[1] = opt_src[1];
          v[2] = opt_src[2];
        }
    ...
    magnitude() {
        // Insert your code here.
        let m = Math.hypot(...this.elements); // Modify this line to calculate this vector's magnitude.
...
class Matrix4 {
     ...
     * @param {Matrix4} opt_src source matrix(option)
     */
    constructor(opt_src = undefined) {
        var i, s, d;
